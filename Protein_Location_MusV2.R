...
write.table(datainte_cyto3, file=paste0(PathName,"/",RVersion,"/cyto_MusTTT.txt"),  
            sep="\t", row.names=FALSE)

write.table(datainte_cyto4, file=paste0(PathName,"/",RVersion,"/cyto_Mus.txt"),  
            sep="\t", row.names=FALSE)

write.table(datainte_cyto4, file=paste0(PathName,"/",RVersion,"/cyto_Mus.csv"),  
            sep=",", row.names=FALSE)
...
write.table(datainte_extra4, file=paste0(PathName,"/",RVersion,"/Extracellular_Mus.txt"),  
            sep="\t", row.names=FALSE)

write.table(datainte_extra4, file=paste0(PathName,"/",RVersion,"/Extracellular_Mus.csv"),  
            sep=",", row.names=FALSE)
...
write.table(CytoGene3, file=paste0(PathName,"/",RVersion,"/CytoGene_Mus_ENSEMBL.csv"),  
            sep=",", row.names=FALSE)
...
write.table(CytoGene5, file=paste0(PathName,"/",RVersion,"/CytoGene_Mus_SYMBOL.csv"),  
            sep=",", row.names=FALSE)
...
write.table(FNkdExoGene3, file=paste0(PathName,"/",RVersion,"/FNkdExoGene_Mus_ENSEMBL.csv"),  
            sep=",", row.names=FALSE)
...
write.table(FNkdExoGene5, file=paste0(PathName,"/",RVersion,"/FNkdExoGene_Mus_SYMBOL.csv"),  
            sep=",", row.names=FALSE)
